            ...
            <form action="" method="post">
                ...
                <div class="mt-[-50px]">
                    ...
                    <div class="flex justify-center">
                        <input type="text" class="block px-4 w-96 h-10 bg-white shadow-2xl rounded-xl border-2 border-[#756AB6] form-control" name="nama" id="nama" aria-describedby="emailHelp" require placeholder="Masukan Nama Kamu">
                    </div>
                    <!-- Email-->
                    <label for="email" class="block px-16 py-2 text-gray-500 font-bold text-sm">Alamat Email</label>
                    <div class="flex justify-center">
                        <input type="text" class="block px-4 w-96 h-10 bg-white shadow-2xl rounded-xl border-2 border-[#756AB6] form-control" name="email" id="email" aria-describedby="emailHelp" require placeholder="Masukan Email Kamu">
                    </div>
                    <!-- password -->
