            ...
            <form action="" method="post">
                <!-- Nama Lengkap -->
                 <div class="lg:mt-[-20px]">
                    <label for="nama" class="block md:mx-56 lg:mx-16 mx-10 py-2 text-gray-500 font-bold text-sm">Nama Lengkap</label>
                    <div class="flex justify-center">
                        <input type="text" class="block md:w-96 w-10/12 px-4 h-10 bg-white shadow-2xl rounded-xl border-2 border-[#756AB6] form-control" name="nama" id="nama" aria-describedby="emailHelp" required placeholder="Masukan Nama">
                    </div>
                    <!-- Email-->
                    <label for="email" class="block md:mx-56 lg:mx-16 mx-10 my-2 text-gray-500 font-bold text-sm">Alamat Email</label>
                    <div class="flex justify-center">
                        <input type="text" class="block md:w-96 w-10/12 px-4 h-10 bg-white shadow-2xl rounded-xl border-2 border-[#756AB6] form-control" name="email" id="email" aria-describedby="emailHelp" required placeholder="Masukan Email">
                    </div>
                    <!-- password -->
                    <label for="password" class="block md:mx-56 lg:mx-16 mx-10 my-2 text-gray-500 font-bold text-sm">Kata Sandi</label>
                    <div class="flex justify-center">
                        <input type="password" class="block px-4 md:w-[345px] w-[305px] h-10 bg-white shadow-2xl rounded-l-xl border-2 border-[#756AB6]" name="password" id="password" required placeholder="Masukan Kata Sandi">
                    ...
                    <!-- konfirmasi password -->
                    <label for="password2" class="block md:mx-56 lg:mx-16 mx-16 my-2 text-gray-500 font-bold text-sm">Konfirmasi Kata Sandi</label>
                    <div class="flex justify-center">
                        <input type="password" class="block px-4 md:w-96 w-10/12 h-10 bg-white shadow-2xl rounded-xl border-2 border-[#756AB6] form-control" name="password2" id="password2" required placeholder="Konfirmasi Kata Sandi">
                    </div>
                    <!-- button -->
