    ...
    <div class="flex py-12 px-40">
        ...
        <div class="flex-1 mx-auto bg-white shadow-2xl rounded-r-2xl w-[500px] h-[500px]">
            ...
            <div class="mt-[-30px]">
                ...
                <div class="flex justify-end px-16 py-2 text-gray-500 font-bold text-sm">Lupa kata sandi?</div>
                <div class="mt-8">
                ...
                <div class="mt-4">
                    <div class="mx-auto rounded-lg w-96 h-10 border-2 border-[#AC87C5]">
                        <div class="text-center text-[#AC87C5] text-sm font-bold pt-[8px]">
